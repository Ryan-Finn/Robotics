...
def drawARM(theta1, theta2, theta3):
    global ws, l1, l2, l3, px, link_width, link1, link2, link3, offset_x, offset_y, base_r, servo1, servo2, servo3
    s = px.get()
...
def plotARM(theta1, theta2, theta3):
    global link1, link2, link3, servo1, servo2, servo3
    ws.delete(link1)
    ws.delete(servo2)
    ws.delete(link2)
    ws.delete(servo3)
    ws.delete(link3)
    drawARM(theta1, theta2, theta3)
...
def buildGUI():
    global root, ws, Draw, l1, l2, l3, px, t1, t2, t3
    root = Tk()
    root.wm_title("3 Link Arm Simulation")
    l1 = IntVar(value='10')
    l2 = IntVar(value='10')
    l3 = IntVar(value='10')
    px = IntVar(value='10')
